...
import miu.edu.cvbuilderapp.utilities.showKeyboard

class EducationAdapter(val onSaveButtonClick: (Education) -> Unit,
					   val onDeleteButtonClick: (Education) -> Unit,
					   val onEditButtonClick: (Education) -> Unit) : RecyclerView.Adapter<miu.edu.cvbuilderapp.adapter.EducationAdapter.EducationViewHolder>() {

	private var educationList: List<Education> = emptyList()

	override fun onCreateViewHolder(parent: ViewGroup, position: Int): miu.edu.cvbuilderapp.adapter.EducationAdapter.EducationViewHolder {
	...
	override fun onBindViewHolder(holder: miu.edu.cvbuilderapp.adapter.EducationAdapter.EducationViewHolder, position: Int) {
	...
	fun updateEducationList(newEducationList: List<Education>) {
		val educationDiffUtilCallback =
			miu.edu.cvbuilderapp.adapter.DiffUtilCallback(
				this.educationList,
				newEducationList
			)
